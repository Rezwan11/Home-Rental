  		...
  		<form action="" method="post" enctype="multipart/form-data">
		  	 <div class="row">
				...
				<div class="col-md-4">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" pattern="^(\d{11})$" id="alternat_mobile" title="11 digit mobile number" placeholder="11 digit mobile number" name="alternat_mobile">
				  </div>
				</div>
			</div>
			...
			<div class="row">
			  ...
			  <div class="form-group">
			    ...
			    <input type="state" class="form-control" id="state" placeholder="District" name="state" required>
			  </div>
			  </div>
			  <div class="col-md-4">
			  <div class="form-group">
